        ...
        <div className="homepage">
                    ...
                    <nav className="nav">
                        ...
                        <div className={`nav-right ${isMenuOpen ? 'open' : ''}`}>
                            <div className="nav-links">
                                <a href="#" className="nav-link" onClick={() => setIsMenuOpen(false)}>Início</a>
                                ...
                                <a href="#pixel" className="nav-link" onClick={() => setIsMenuOpen(false)}>Metodologia</a>
                                <a href="#clientes" className="nav-link" onClick={() => setIsMenuOpen(false)}>Clientes</a>
                            </div>
            ...
            <section className="white-section" id="servicos">
                <div className="white-container">
                    <h2 className="white-title">Nossos Serviços</h2>
            ...
            <section className="clients-section" id="clientes">
                <div className="clients-container">
                    <h2 className="clients-title">Nossos Clientes e Parceiros</h2>
                    ...
                    <div className="clients-grid">
                        {/* Cliente 1 */}
                        <a href="https://echotap.com.br" target="_blank" rel="noopener noreferrer" className="client-card bg-white">
                        ...
                        {/* Cliente 2 */}
                        <a href="https://www.portalbereana.com.br" target="_blank" rel="noopener noreferrer" className="client-card bg-white">
                            <div className="client-logo">
                        ...
                        {/* Cliente 3 */}
                        <a href="https://mide.com.br" target="_blank" rel="noopener noreferrer" className="client-card bg-black">
                            <div className="client-logo">
                        ...
                        {/* Cliente 4 */}
                        <a href="https://selfspiral.com.br" target="_blank" rel="noopener noreferrer" className="client-card bg-white">
                            <div className="client-logo">
                        ...
                        {/* Cliente 5 */}
                        <a href="https://diamondlog.tec.br" target="_blank" rel="noopener noreferrer" className="client-card bg-black">
                            <div className="client-logo">
                        ...
                        {/* Cliente 6 */}
                        <a href="https://www.instagram.com/bikusrotisserie" target="_blank" rel="noopener noreferrer" className="client-card bg-white">
                            <div className="client-logo">
                        ...
                        {/* Cliente 7 */}
                        <a href="https://www.instagram.com/bikus.confeitaria" target="_blank" rel="noopener noreferrer" className="client-card bg-black">
                            <div className="client-logo">
